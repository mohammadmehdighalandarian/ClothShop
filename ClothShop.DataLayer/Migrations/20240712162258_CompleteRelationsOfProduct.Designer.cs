...
namespace ClothShop.DataLayer.Migrations
{
    ...
    [Migration("20240712162258_CompleteRelationsOfProduct")]
    partial class CompleteRelationsOfProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductUserProduct", b =>
                {
                    b.Property<int>("ProductsProductId")
                        .HasColumnType("int");

                    b.Property<int>("UserProductsUserProduct_Id")
                        .HasColumnType("int");

                    b.HasKey("ProductsProductId", "UserProductsUserProduct_Id");

                    b.HasIndex("UserProductsUserProduct_Id");

                    b.ToTable("ProductUserProduct");
                });

            modelBuilder.Entity("UserUserProduct", b =>
                {
                    b.Property<int>("UserProductsUserProduct_Id")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserProductsUserProduct_Id", "UsersUserId");

                    b.HasIndex("UsersUserId");

                    b.ToTable("UserUserProduct");
                });
            ...
            modelBuilder.Entity("ClothShop.DataLayer.Entities.Product.ProductMaterial", b =>
                {
                    b.HasOne("ClothShop.DataLayer.Entities.Product.Product", null)
            ...
            modelBuilder.Entity("ProductUserProduct", b =>
                {
                    ...
                    b.HasOne("ClothShop.DataLayer.Entities.Product.UserProduct", null)
                        .WithMany()
                        .HasForeignKey("UserProductsUserProduct_Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
